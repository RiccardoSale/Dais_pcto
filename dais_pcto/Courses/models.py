...
class Course(UserMixin, db.Model):
    ...
    mode = db.Column(db.String(10), nullable=False)  # modalita 0 = online modalità 1 = presenza modalita 3 = blendend
    ...
    lessons = db.relationship('Lesson', backref='courses') #molti a uno dove uno è il corso
    ...
    r_users = db.relationship("User", secondary=user_course, back_populates="r_courses")#collegamento molti a molti tra utenti e corsi per fattore iscrizione utente normale
    #usiamo come tabella secondaria user_course
